...
let a_x=prompt(" a nöqtəsinin Ox oxu üzrə koordinantı");
let a_y=prompt(" a nöqtəsinin Oy oxu üzrə koordinantı");
let b_x=prompt(" b nöqtəsinin Ox oxu üzrə koordinantı");
let b_y=prompt(" b nöqtəsinin Oy oxu üzrə koordinantı");
...
let mesafe_ab = Math.pow(a_x-b_x, 2) + Math.pow(a_y-b_y, 2);
mesafe_ab=Math.sqrt(mesafe_ab);
