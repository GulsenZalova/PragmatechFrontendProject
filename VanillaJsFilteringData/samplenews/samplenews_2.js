...
// let ad="Me he mm ed el i";
// let arr=ad.split(" ");
// console.log(arr)
// let parcala=arr.join("")
// console.log(parcala)
// console.log(ad.length-parcala.length)

// function spaceFind(){
//     let arr=sampleNews.split(" ");
//     console.log(arr);
//     let arrjoin=arr.join("");
//     console.log(arrjoin)
//     console.log(arrjoin.length);
//     console.log(arrjoin.length-arr.length)
// }
// spaceFind()